...
**Rule:** External feedback is useful, but check it against the codebase.
...
**Rule:** If the project does not need the feature, do not add it just because a
reviewer suggested a more elaborate version.
...
If uncertain, state the uncertainty directly: "I want to verify this before
changing it."
...
**Why keep it brief:** Actions speak. The code and verification show you heard
the feedback.

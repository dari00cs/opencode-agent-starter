---
name: gpt-tasteskill
description: Extreme showcase variant for bold marketing sites and motion-heavy landing
  pages. Use only when the user clearly wants Awwwards-style, GSAP-heavy, hero-led,
  editorial, cinematic, or experimental showcase UI. Do not auto-select for generic
  UI improvement or normal premium frontend work; prefer taste-skill unless the brief
  explicitly calls for this stronger direction.
---

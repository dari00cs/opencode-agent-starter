...
**Complete worked example:** Build a small pressure-test matrix for the exact
skill behavior you want to enforce, then run it without and with the skill so
you can see whether the skill changes agent behavior.
